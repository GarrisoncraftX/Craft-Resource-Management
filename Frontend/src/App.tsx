...
const ReportBuilder = lazy(() => import("@/components/modules/reports/ReportBuilder").then(module => ({ default: module.ReportBuilder })));
    ...
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <SuspenseWrapper>
              <ModuleLayout title="Asset Management" onViewDashboard={handleViewDashboard} onLogout={handleLogout}>
                <AssetRegister />
              </ModuleLayout>
            </SuspenseWrapper>
          </ProtectedRoute>
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <SuspenseWrapper>
              <ModuleLayout title="HR Dashboard" onViewDashboard={handleViewDashboard} onLogout={handleLogout}>
                <EmployeeProfiles />
              </ModuleLayout>
            </SuspenseWrapper>
          </ProtectedRoute>
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <SuspenseWrapper>
              <ModuleLayout title="Procurement" onViewDashboard={handleViewDashboard} onLogout={handleLogout}>
                <ProcurementPlanning />
              </ModuleLayout>
            </SuspenseWrapper>
          </ProtectedRoute>
      ...
      />
      <Route
        path="/procurement/requisitioning"
        element={
          <ProtectedRoute>
            <SuspenseWrapper>
              <ModuleLayout title="Procurement" onViewDashboard={handleViewDashboard} onLogout={handleLogout}>
      ...
      />
        ...
        <Route path="/planning/urban" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Planning" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><UrbanPlanning /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/planning/projects" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Planning" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><ProjectManagement /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        
        /* Public Relations Routes */
        <Route path="/pr/releases" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Public Relations" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><PressReleases /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        
        /* Revenue Routes */  
        <Route path="/revenue/assessment" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Revenue" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><TaxAssessment /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        
        /* Reports Routes */
        <Route path="/reports/builder" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Reports" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><ReportBuilder /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        
        <Route path="/revenue" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Revenue" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><RevenueDashboard /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/reports" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Reports" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><ReportsDashboard /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/transportation" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Transportation" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><TransportationDashboard /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/security" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Security" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><SecurityDashboard /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/public-relations" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Public Relations" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><PublicRelationsDashboard /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        {/* Admin Routes */}
        <Route path="/admin/dashboard" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><AdminDashboard /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/admin/users" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><UserManagement /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/admin/settings" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><SystemSettings /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/admin/security" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><Security /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/admin/database" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><DatabaseManagement /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/admin/monitoring" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><SystemMonitoring /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/admin/notifications" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><Notifications /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
        <Route path="/admin/logs" element={
          <ProtectedRoute><SuspenseWrapper><ModuleLayout title="Admin" onViewDashboard={handleViewDashboard} onLogout={handleLogout}><AuditLogs /></ModuleLayout></SuspenseWrapper></ProtectedRoute>
        } />
