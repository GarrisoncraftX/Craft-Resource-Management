    ...
    <div className="min-h-screen flex-1 flex flex-col p-6 bg-background">
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <div>
            <h1 className="text-3xl lg:text-2xl sm:text-sm font-bold tracking-tight">Components</h1>
\          </div>
        </div>
            ...
            <>
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  ...
                  <TooltipContent><p>Clone Component</p></TooltipContent>
                </Tooltip>
              </TooltipProvider>
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  ...
                  <TooltipContent><p>Edit Component</p></TooltipContent>
                </Tooltip>
              </TooltipProvider>
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  ...
                  <TooltipContent><p>Delete Component</p></TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </>
          )}
