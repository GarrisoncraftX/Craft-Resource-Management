  ...
  const handleSignin = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        ...(faceData && { faceData }),
        ...(fingerprintTemplate && { fingerprintId: fingerprintTemplate }),
      };
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        ...(faceData && { faceData }),
        ...(fingerprintTemplate && { fingerprintId: fingerprintTemplate }),
        ...(idCardData && { cardId: idCardData.cardId }),
      };
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <form onSubmit={handleSignin} className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex gap-2">
                    ...
                    >
                      {showFingerprint ? 'Hide' : 'Use'} Fingerprint
                    </Button>
                  </div>
                  ...
                  {showFingerprint && (
                    <div>
                      <FingerprintScanner onCapture={setFingerprintTemplate} isActive={showFingerprint} />
                    </div>
                  )}
                </div>
            ...
            <TabsContent value="register" className="space-y-4">
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                {/* Biometric Enrollment for Registration */}
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {showFingerprint ? 'Hide' : 'Scan'} Fingerprint
                    </Button>
                  </div>
