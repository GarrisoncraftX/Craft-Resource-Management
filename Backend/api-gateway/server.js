...
const allowedOrigins= [process.env.FRONTEND_URL || "http://192.168.1.67:5173", "*"]; 
app.use(cors({
...
const javaBackend = process.env.JAVA_BACKEND_URL || "http://192.168.1.67:5002";
const nodeBackend = process.env.NODE_BACKEND_URL || "http://192.168.1.67:5001";
const pythonBackend = process.env.PYTHON_BACKEND_URL || "http://192.168.1.67:5000";
