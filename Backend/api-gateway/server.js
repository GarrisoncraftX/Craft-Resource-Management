...
const allowedOrigins= [process.env.FRONTEND_URL || "http://172.20.10.5:5173", "*"]; 
app.use(cors({
...
const javaBackend = process.env.JAVA_BACKEND_URL || "http://172.20.10.5:5002";
const nodeBackend = process.env.NODE_BACKEND_URL || "http://172.20.10.5:5001";
const pythonBackend = process.env.PYTHON_BACKEND_URL || "http://172.20.10.5:5000";
